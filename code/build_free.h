...
int BuildInstance(string filename)
{
    ...
    for (e = 0; e < 2 * e_num; e += 2)
    {
        //infile >> tmp >> v1 >> v2;
        //infile>>v1>>v2;
        infile >> edge[e].u >> edge[e].v;
        //infile>>tmp>>edge[e].u>>edge[e].v;
        //edge[e].u=v1;edge[e].v=v2;
        v1 = edge[e].u;
        v2 = edge[e].v;
        edge[e].next = first[edge[e].u];
        first[edge[e].u] = e;
        edge[e + 1].u = edge[e].v;
        edge[e + 1].v = edge[e].u;
        edge[e + 1].next = first[edge[e + 1].u];
        first[edge[e + 1].u] = e + 1;
        v_degree[v1]++;
        v_degree[v2]++;
    }
    infile.close();
